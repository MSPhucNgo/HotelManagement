...
CREATE TABLE PARTICIPATION(
	...
	CONSTRAINT PK_PARTICIPATION PRIMARY KEY (ID_CUSTOMER_TOUR, ID_CUSTOMER)
)
...
-- SERVICE_BILL(CUSTOMER) -> CUSTOMER(ID_CUSTOMER)
ALTER TABLE SERVICE_BILL
ADD CONSTRAINT FK_SB_CUSTOMER
FOREIGN KEY (CUSTOMER)
REFERENCES CUSTOMER(ID_CUSTOMER)

-- BILL(CUSTOMER) -> CUSTOMER(ID_CUSTOMER)
ALTER TABLE BILL
...
-- PARTICIPATION(ID_CUSTOMER_TOUR) -> CUSTOMER_TOUR(ID_CUSTOMER_TOUR)
ALTER TABLE PARTICIPATION
ADD CONSTRAINT FK_PAR_TOUR
FOREIGN KEY (ID_CUSTOMER_TOUR)
REFERENCES CUSTOMER_TOUR(ID_CUSTOMER_TOUR)

-- PARTICIPATION(ID_CUSTOMER) -> CUSTOMER(ID_CUSTOMER)
ALTER TABLE PARTICIPATION
ADD CONSTRAINT FK_PAR_CUS
FOREIGN KEY (ID_CUSTOMER)
REFERENCES CUSTOMER(ID_CUSTOMER)

-- CUSTOMER(ID_INFORMATION_FORM) -> INFORMATION_FORM(ID_INFORMATION_FORM)
ALTER TABLE CUSTOMER
ADD CONSTRAINT FK_INFOR_FORM
...
INSERT INTO ACCOUNT VALUES ('EMP11','1234')

create 
--alter
function usp_loginuser(
	@username char(10),
	@pass char(10)
)
returns bit
as
begin
	if(exists(select * from dbo.ACCOUNT where username = @username and password = @pass))
		begin
			return 1
		end
		return 0
